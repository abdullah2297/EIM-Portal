...
export const RESOURCE_CONFIG = {
  ...
  [RESOURCES.trainingCategories]: {
    ...
    titleField: 'name',
    searchable: ['name', 'description'],
    filterable: ['trainingTypeId', 'active'],
    sort: { field: 'order', order: 'asc' },
    icon: 'Category',
  },
  [RESOURCES.trainings]: {
    ...
    idPrefix: 'trn',
    titleField: 'name',
    searchable: ['name', 'shortDescription', 'fullDescription', 'instructorName', 'language'],
    filterable: ['categoryId', 'level', 'deliveryMethod', 'status', 'featured'],
  ...
  [RESOURCES.trainingRegistrations]: {
    ...
    searchable: ['computerNumber', 'phoneNumber'],
    filterable: ['trainingId', 'employeeId', 'status'],
    sort: { field: 'createdAt', order: 'desc' },
    icon: 'HowToReg',
    // Holds a computer number and phone number - never let the generic
    // GET expose this collection to anonymous requests.
    privateRead: true,
  },
